...
class GaussianDiffusion:
    ...
    def ddim_sample_operation(
        ...
        """
        See https://github.com/arpitbansal297/Universal-Guided-Diffusion/blob/b3af48f78d7bec105f3ea1579faf8602c520ed1e/Guided_Diffusion_Imagenet/guided_diffusion/gaussian_diffusion.py#L603
        Sample x_{t-1} from the model using DDIM.
        Same usage as p_sample().
        """
        ...
        for j in range(operation.num_recurrences):
            ...
            out["pred_xstart"] = th.clamp(x0, -1, 1)
